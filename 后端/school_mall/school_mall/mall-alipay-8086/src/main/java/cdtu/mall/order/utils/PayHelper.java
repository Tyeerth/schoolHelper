package cdtu.mall.order.utils;

import cdtu.mall.order.config.PayConfig;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        String key = "mall.pay.url." + orderId;
        try {
        ...
        try {
            ...
            //回调地址，付款成功后的接口
            data.put("notify_url", "http://localhost:8001/#/orderDetail");
            // 交易类型为扫码支付
