...
import cdtu.mall.service.config.UnitConfig;
import cdtu.mall.service.utils.HttpUtil;
...
public class UnitService {
    ...
    private UnitConfig unitConfig;
        public String utterance(String query,String botId,String userId) {
            ...
            try {
                // 请求参数
                String params = "{\"bot_session\":\"\",\"log_id\":\""+log_id+"\",\"request\":{\"bernard_level\":1,\"client_session\":\"{\\\"client_results\\\":\\\"\\\", \\\"candidate_options\\\":[]}\",\"query\":\""+query+"\",\"query_info\":{\"asr_candidates\":[],\"source\":\"KEYBOARD\",\"type\":\"TEXT\"},\"updates\":\"\",\"user_id\":\""+userId+"\"},\"bot_id\":\""+botId+"\",\"version\":\"2.0\"}";
